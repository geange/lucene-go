...
//	IntField(fieldInfo *types.FieldInfo, value int) error
//
...
//	FloatField(fieldInfo *types.FieldInfo, value float64) error
//
...
//	NeedsField(fieldInfo *types.FieldInfo) StoredFieldVisitorStatus
//}
