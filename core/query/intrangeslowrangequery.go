...
func NewIntRangeSlowRangeQuery(field string, minNums, maxNums []int32, queryType QueryType) (*IntRangeSlowRangeQuery, error) {
	packedValues, err := encodeIntRanges(minNums, maxNums)
	if err != nil {
		return nil, err
	}
