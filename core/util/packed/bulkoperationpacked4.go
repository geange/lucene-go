...
func (b *BulkOperationPacked4) DecodeInts(blocks, values []int64, iterations int) {
...
func (b *BulkOperationPacked4) DecodeBytes(blocks []byte, values []int64, iterations int) {
	blocksOffset, valuesOffset := 0, 0
