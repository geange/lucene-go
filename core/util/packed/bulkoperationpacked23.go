...
func (b *BulkOperationPacked23) DecodeByteToLong(blocks []byte, values []int64, iterations int) {
	...
	for i := 0; i < iterations; i++ {
		...
		byte3 := int64(blocks[blocksOffset])
		blocksOffset++
		byte4 := int64(blocks[blocksOffset])
		blocksOffset++
		byte5 := int64(blocks[blocksOffset])
		blocksOffset++
		values[valuesOffset] = ((byte2 & 1) << 22) | (byte3 << 14) | (byte4 << 6) | (byte5 >> 2)
		valuesOffset++
		byte6 := int64(blocks[blocksOffset])
		blocksOffset++
		byte7 := int64(blocks[blocksOffset])
		blocksOffset++
		byte8 := int64(blocks[blocksOffset])
		blocksOffset++
		values[valuesOffset] = ((byte5 & 3) << 21) | (byte6 << 13) | (byte7 << 5) | (byte8 >> 3)
		valuesOffset++
		byte9 := int64(blocks[blocksOffset])
		blocksOffset++
		byte10 := int64(blocks[blocksOffset])
		blocksOffset++
		byte11 := int64(blocks[blocksOffset])
		blocksOffset++
		values[valuesOffset] = ((byte8 & 7) << 20) | (byte9 << 12) | (byte10 << 4) | (byte11 >> 4)
		valuesOffset++
		byte12 := int64(blocks[blocksOffset])
		blocksOffset++
		byte13 := int64(blocks[blocksOffset])
		blocksOffset++
		byte14 := int64(blocks[blocksOffset])
		blocksOffset++
		values[valuesOffset] = ((byte11 & 15) << 19) | (byte12 << 11) | (byte13 << 3) | (byte14 >> 5)
		valuesOffset++
		byte15 := int64(blocks[blocksOffset])
		blocksOffset++
		byte16 := int64(blocks[blocksOffset])
		blocksOffset++
		byte17 := int64(blocks[blocksOffset])
		blocksOffset++
		values[valuesOffset] = ((byte14 & 31) << 18) | (byte15 << 10) | (byte16 << 2) | (byte17 >> 6)
		valuesOffset++
		byte18 := int64(blocks[blocksOffset])
		blocksOffset++
		byte19 := int64(blocks[blocksOffset])
		blocksOffset++
		byte20 := int64(blocks[blocksOffset])
		blocksOffset++
		values[valuesOffset] = ((byte17 & 63) << 17) | (byte18 << 9) | (byte19 << 1) | (byte20 >> 7)
		valuesOffset++
		byte21 := int64(blocks[blocksOffset])
		blocksOffset++
		byte22 := int64(blocks[blocksOffset])
		blocksOffset++
...
func (b *BulkOperationPacked23) DecodeByteToInt(blocks []byte, values []int32, iterations int) {
	blocksOffset, valuesOffset := 0, 0
	for i := 0; i < iterations; i++ {
		...
		blocksOffset++
		byte11 := int32(blocks[blocksOffset])
		blocksOffset++
		values[valuesOffset] = ((byte8 & 7) << 20) | (byte9 << 12) | (byte10 << 4) | (byte11 >> 4)
		valuesOffset++
		byte12 := int32(blocks[blocksOffset])
		blocksOffset++
		byte13 := int32(blocks[blocksOffset])
		blocksOffset++
		byte14 := int32(blocks[blocksOffset])
		blocksOffset++
		values[valuesOffset] = ((byte11 & 15) << 19) | (byte12 << 11) | (byte13 << 3) | (byte14 >> 5)
		valuesOffset++
		byte15 := int32(blocks[blocksOffset])
		blocksOffset++
		byte16 := int32(blocks[blocksOffset])
		blocksOffset++
		byte17 := int32(blocks[blocksOffset])
		blocksOffset++
		values[valuesOffset] = ((byte14 & 31) << 18) | (byte15 << 10) | (byte16 << 2) | (byte17 >> 6)
		valuesOffset++
		byte18 := int32(blocks[blocksOffset])
		blocksOffset++
		byte19 := int32(blocks[blocksOffset])
		blocksOffset++
		byte20 := int32(blocks[blocksOffset])
		blocksOffset++
		values[valuesOffset] = ((byte17 & 63) << 17) | (byte18 << 9) | (byte19 << 1) | (byte20 >> 7)
		valuesOffset++
		byte21 := int32(blocks[blocksOffset])
		blocksOffset++
		byte22 := int32(blocks[blocksOffset])
		blocksOffset++
		values[valuesOffset] = ((byte20 & 127) << 16) | (byte21 << 8) | byte22
		valuesOffset++
	}
