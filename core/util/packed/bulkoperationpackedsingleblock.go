...
func (b *BulkOperationPackedSingleBlock) decodeInt(block uint64, values []int32, valuesOffset int) int {
...
func (b *BulkOperationPackedSingleBlock) encodeInt(values []int32, valuesOffset int) uint64 {
...
func (b *BulkOperationPackedSingleBlock) DecodeUint64(blocks []uint64, values []uint64, iterations int) {
...
func (b *BulkOperationPackedSingleBlock) DecodeBytes(blocks []byte, values []uint64, iterations int) {
	blocksOffset, valuesOffset := 0, 0
	for i := 0; i < iterations; i++ {
...
func (b *BulkOperationPackedSingleBlock) EncodeUint64(values []uint64, blocks []uint64, iterations int) {
	blocksOffset, valuesOffset := 0, 0
...
func (b *BulkOperationPackedSingleBlock) EncodeBytes(values []uint64, blocks []byte, iterations int) {
	blocksOffset, valuesOffset := 0, 0
	for i := 0; i < iterations; i++ {
