...
type SegmentCommitInfo index.SegmentCommitInfo
...
//}
//
//func NewSegmentCommitInfo(info index.SegmentInfo, delCount, softDelCount int,
...
//}
//
//func (s *SegmentCommitInfo) Info() index.SegmentInfo {
//	return s.info
//}
//
